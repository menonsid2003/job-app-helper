...
class LocationBackfillRunState:
    """Same shape as TailorAllRunState/AgentApplyRunState — a separate,
    independently-triggerable run (see app/location_backfill.py)."""
    ...
    def request_stop(self) -> None:
        ...
        self.log("Stop requested — will halt after the current source finishes…")
...
location_backfill_state = LocationBackfillRunState()
